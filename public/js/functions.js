$(document).ready(function() {
    ...
    $('#dateInput1').Zebra_DatePicker();
    $('#dateInput2').Zebra_DatePicker();
    $('#dateInput3').Zebra_DatePicker();
    $('#dateInput4').Zebra_DatePicker();
    $('#dateInput5').Zebra_DatePicker();
    $('#dateInput6').Zebra_DatePicker();
    ...
    $('#datepicker-example7-end').Zebra_DatePicker({
        direction: ['2012-08-01', '2012-08-01']
    });
